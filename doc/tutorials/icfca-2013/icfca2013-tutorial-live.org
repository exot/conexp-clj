...
exectued directly.  See [[file:~/Documents/projects/conexp-clj/doc/Development.org::#setting-up-emacs-to-run-clojure-code][Setting up Emacs to Run Clojure Code]] for how to exectue
